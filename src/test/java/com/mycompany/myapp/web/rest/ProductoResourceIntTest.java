...
public class ProductoResourceIntTest {
    ...
    public void createProducto() throws Exception {
        ...
        assertThat(testProducto.getVencimiento()).isEqualTo(DEFAULT_VENCIMIENTO);
        assertThat(testProducto.isActivo()).isEqualTo(DEFAULT_ACTIVO);
    }
    ...
    public void updateProducto() throws Exception {
        ...
        assertThat(testProducto.getVencimiento()).isEqualTo(UPDATED_VENCIMIENTO);
        assertThat(testProducto.isActivo()).isEqualTo(UPDATED_ACTIVO);
    }
