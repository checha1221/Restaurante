...
public class RestauranteResource {
    ...
    @Timed
    public ResponseEntity<Restaurante> createRestaurante(@RequestBody Restaurante restaurante) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<Restaurante> updateRestaurante(@RequestBody Restaurante restaurante) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<List<Restaurante>> getAllRestaurantes(@ApiParam Pageable pageable) {
